...
read3=open("strengths.txt","r")
read33=read1.readlines()
read4=open("flaws.txt","r")
read44=read2.readlines()
...
for i in range(0,len(read11)):
    ...
    temp_summary2="Given the definition of human evaluation metrics:Grammaticality: Measures the grammatical correctness of the generated question, regardless of the context; Relevance: Measures the degree to which the generated question is pertinent and aligned with the given context.Appropriateness: Examines the semantic correctness of the question irrespective of the context;Novelty: Measures the originality and distinctiveness of the generated question in comparison to the gold standard question for the given context. Complexity: Estimates the level of reasoning or cognitive effort required to answer the generated question. The Context corresponding to the question is: {"+read22[i]+"} The Strengths in the question is: {"+read33[i]+"} The Flaws in the question is: {"+read44[i]+"} Act as a Judge, and choose the best Strength and Flaw from the above information.Provide a score between 1 and 5 for the question {"+read11[i]+"} based on the human evaluation metrics namely Grammaticality, Appropriateness, Relevance, Complexity, and Novelty as well as the context, strengths, flaws corresponding to the question stated above."
            #try:
